    ...
    <footer class="page-footer">
      ...
      <div class="footer-nav">
        <div class="container clearfix">
          ...
          <div class="footer-nav__col footer-nav__col--contacts">
            ...
            Head Office: SRH Fashion.<br>
            Breslauer Str.10,Sandhausen, Germany.
          </address>
            <div class="phone">
              Telephone:
              <a class="phone__number" href="tel:0123456789">+4915219235249</a>
            </div>
            <div class="email">
              Email:
      ...
      <div class="page-footer__subline">
        <div class="container clearfix">
          ...
          <div class="copyright">
            &copy; 2021 SRH Fashion&trade;
          </div>

          <div class="developer">
            Dev by Thanmai, Aniruddh, Mitali, Yash, Mahima
          </div>

          <div class="designby">
            Design by Thanmai, Aniruddh, Mitali, Yash, Mahima
          </div>
